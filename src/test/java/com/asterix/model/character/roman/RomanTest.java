...
class RomanTest {
     ...
     * IMPORTANT: we do NOT override toString(),
     * so we actually execute Roman.toString().
     */
    ...
    void romanToStringShouldContainClassNameAndName() {
        ...
        // Adapte ces assertions si ton toString est différent,
        // mais pour quelque chose comme:
        // return "Roman [Name=" + name + ", Health=" + health + ", Strength=" + strength + "]";
